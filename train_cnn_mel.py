...
model_1 = DeepCNN([16, 32], (128, 44), (3, 3)).to(device)
    ...
    for i, data in enumerate(train_loader):
        ...
        if i % 500 == 499:
            ...
            if val_loss < init_loss:
                torch.save(model_1, os.path.join(save_path, 'cnn_mel.pt'))
...
np.save("C:/Users/infected4098/Desktop/LYJ/Audio Clf with Pytorch/cnn_mel_valloss.npy", val_loss_history)
np.save("C:/Users/infected4098/Desktop/LYJ/Audio Clf with Pytorch/cnn_mel_loss.npy", loss_history)
#torch.save(model_1.state_dict(), "C:/Users/infected4098/Desktop/LYJ/Audio Clf with Pytorch/cnn_mfcc.pt")


cnn_mel = torch.load(os.path.join(save_path, 'cnn_mel.pt'))
from evaluate import test_model
preds, labels = test_model(cnn_mel, X_test, y_test, device, cnn = True)
